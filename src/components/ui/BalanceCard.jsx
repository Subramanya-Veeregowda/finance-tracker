...
export default function Card({ title, value }) {
  return (
    <div className="flex flex-col justify-center items-center h-[160px] w-full bg-blue-100/40 hover:bg-blue-200/70 dark:bg-blue-900/20 
                    hover:dark:bg-blue-900/40 text-black backdrop-blur-xl 
